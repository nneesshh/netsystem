...
//------------------------------------------------------------------------------
/**
@brief CUvGateIsolatedConn
*/
class CUvGateIsolatedConn : public ITcpIsolated
{
public:
	CUvGateIsolatedConn(uint64_t uConnId, ITcpConnFactory *pFactory);
	virtual ~CUvGateIsolatedConn();
