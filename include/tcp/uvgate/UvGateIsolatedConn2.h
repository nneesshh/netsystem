...
//------------------------------------------------------------------------------
/**
@brief CUvGateIsolatedConn2
*/
class CUvGateIsolatedConn2 : public ITcpIsolated
{
public:
	CUvGateIsolatedConn2(uint64_t uConnId, ITcpConnFactory *pFactory);
	virtual ~CUvGateIsolatedConn2();
...
private:
	...
	// 
	uv_timer_t *_reconnectTimer = nullptr;
