...
//------------------------------------------------------------------------------
/** 
	@brief CKjGateIsolatedConn2
*/
class CKjGateIsolatedConn2 : public ITcpIsolated, public kj::TaskSet::ErrorHandler {
public:
	CKjGateIsolatedConn2(uint64_t uConnId, ITcpConnFactory *pFactory);
	virtual ~CKjGateIsolatedConn2() noexcept;
