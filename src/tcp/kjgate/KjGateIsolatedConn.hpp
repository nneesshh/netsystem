...
//------------------------------------------------------------------------------
/** 
	@brief CKjGateIsolatedConn
*/
class CKjGateIsolatedConn : public ITcpIsolated, public kj::TaskSet::ErrorHandler {
public:
	CKjGateIsolatedConn(uint64_t uConnId, ITcpConnFactory *pFactory);
	virtual ~CKjGateIsolatedConn() noexcept;
