...
//------------------------------------------------------------------------------
/**
@brief CUvIsolatedConn2
*/
class CUvIsolatedConn2 : public ITcpIsolated
{
public:
	CUvIsolatedConn2(uint64_t uConnId, ITcpConnFactory *pFactory);
	virtual ~CUvIsolatedConn2();
