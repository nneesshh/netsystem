...
//------------------------------------------------------------------------------
/**
@brief CUvIsolatedConn
*/
class CUvIsolatedConn : public ITcpIsolated
{
public:
	CUvIsolatedConn(uint64_t uConnId, ITcpConnFactory *pFactory);
	virtual ~CUvIsolatedConn();
