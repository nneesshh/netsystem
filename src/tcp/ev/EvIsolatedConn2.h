...
//------------------------------------------------------------------------------
/**
@brief CEvIsolatedConn2
*/
class CEvIsolatedConn2 : public ITcpIsolated
{
public:
	CEvIsolatedConn2(uint64_t uConnId, ITcpConnFactory *pFactory);
	virtual ~CEvIsolatedConn2();
