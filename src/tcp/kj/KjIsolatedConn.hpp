...
//------------------------------------------------------------------------------
/** 
	@brief CKjIsolatedConn
*/
class CKjIsolatedConn : public ITcpIsolated, public kj::TaskSet::ErrorHandler {
public:
	CKjIsolatedConn(uint64_t uConnId, ITcpConnFactory *pFactory);
	virtual ~CKjIsolatedConn() noexcept;
